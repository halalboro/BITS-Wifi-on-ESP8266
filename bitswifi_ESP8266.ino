...
const uint8_t fingerprint[20] = {0x47, 0x40, 0x2A, 0xAD, 0x9F, 0x38, 0x4A, 0x40, 0x50, 0x9F, 0x53, 0x5C, 0xC1, 0xBA, 0xD6, 0xBB, 0xFC, 0xBB, 0xE8, 0x3D}; //SHA-1 Fingerprint of the website ( is required as the website is https and not http )
